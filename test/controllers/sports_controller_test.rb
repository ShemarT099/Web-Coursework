...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { description: @sport.description, image_url: @sport.image_url, sport_id: @sport.sport_id, title: @sport.title } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { description: @sport.description, image_url: @sport.image_url, sport_id: @sport.sport_id, title: @sport.title } }
