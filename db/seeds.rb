...
#f = Sport.create!(title: 'American Football', description: 'score a touchdown or field goal, pass the ball or run the ball. Enjoy this evolving sport	',sport_id: 10, image_url: 'amfootball.png')
#Book.create!(Name: 'a', Email: 'a@.com', sport: f.title, When: 2020_11_28_220446, Tickets: 1)
#Book.create!(Name: 'a', Email: 'a@.com', sport: "Football", When: 2020_11_28_220446, Tickets: 1)
